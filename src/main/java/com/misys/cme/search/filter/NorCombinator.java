...
/**
 * Represents the boolean NOR operator in search filters.
 * This is specified by a "$nor" field in the filter JSON.
 */
public class NorCombinator implements CombinatorNode {
	private List<Query> filters;
	
	/**
	 * Constructs a NorCombinator from the given List of Query.
	 * @param filters List of Query to be NORed together.
	 */
	public NorCombinator(List<? extends Query> filters) {
		this.filters = new ArrayList<>();
		this.filters.addAll(filters);
	}
	
	/**
	 * Gets the List of Query that will be NORed together by this.
	 * @return List of Query this NorCombinator is combining.
	...
	public String toString() {
		String output = "NorCombinator{filters=[";
