...
/**
 * Represents the boolean AND operator in search filters.
 * This is specified by a "$and" field in the filter JSON.
 */
public class AndCombinator implements CombinatorNode {
	private List<Query> filters;
	
	/**
	 * Constructs an AndCombinator from the given List of Query.
	 * @param filters List of Query to be ANDed together.
	 */
	public AndCombinator(List<? extends Query> filters) {
		this.filters = new ArrayList<>();
		this.filters.addAll(filters);
	}

	/**
	 * Gets the List of Query that will be ANDed together by this.
	 * @return List of Query this AndCombinator is combining.
	...
	public String toString() {
		String output = "AndCombinator{filters=[";
